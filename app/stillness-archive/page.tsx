...
import { editions, formatReleaseDate } from "../../data/stillness-archive";

/* ──────────────────────────────────────────────
   upcoming editions we want to tease on the index
   (no poems yet — purely scheduled placeholders)
   ────────────────────────────────────────────── */
...
export default function StillnessArchivePage() {
  ...
  const live = [...editions].reverse(); // newest first
